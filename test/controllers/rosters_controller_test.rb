...
class RostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roster" do
    assert_difference('Roster.count') do
      post rosters_url, params: { roster: { playlist_id: @roster.playlist_id, song_id: @roster.song_id } }, as: :json
    end
  ...
  test "should update roster" do
    patch roster_url(@roster), params: { roster: { playlist_id: @roster.playlist_id, song_id: @roster.song_id } }, as: :json
    assert_response 200
  end
